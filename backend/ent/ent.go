...
func checkColumn(t, c string) error {
	initCheck.Do(func() {
		columnCheck = sql.NewColumnCheck(map[string]func(string) bool{
			...
			subscriptionresetcardgrant.Table:    subscriptionresetcardgrant.ValidColumn,
			subscriptionresetcardusage.Table:    subscriptionresetcardusage.ValidColumn,
			subscriptionresetpreference.Table:   subscriptionresetpreference.ValidColumn,
