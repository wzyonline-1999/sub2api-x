...
func (_u *UserUpdate) AddSubscriptionResetCardGrantIDs(ids ...int64) *UserUpdate {
	_u.mutation.AddSubscriptionResetCardGrantIDs(ids...)
	return _u
}

// AddSubscriptionResetCardGrants adds the "subscription_reset_card_grants" edges to the SubscriptionResetCardGrant entity.
func (_u *UserUpdate) AddSubscriptionResetCardGrants(v ...*SubscriptionResetCardGrant) *UserUpdate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _u.AddSubscriptionResetCardGrantIDs(ids...)
}
...
func (_u *UserUpdate) AddIssuedSubscriptionResetCardGrantIDs(ids ...int64) *UserUpdate {
	_u.mutation.AddIssuedSubscriptionResetCardGrantIDs(ids...)
	return _u
}
...
func (_u *UserUpdate) AddIssuedSubscriptionResetCardGrants(v ...*SubscriptionResetCardGrant) *UserUpdate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _u.AddIssuedSubscriptionResetCardGrantIDs(ids...)
}
...
func (_u *UserUpdate) AddSubscriptionResetCardUsageIDs(ids ...int64) *UserUpdate {
...
func (_u *UserUpdate) AddSubscriptionResetCardUsages(v ...*SubscriptionResetCardUsage) *UserUpdate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *UserUpdate) AddSubscriptionResetPreferenceIDs(ids ...int64) *UserUpdate {
	_u.mutation.AddSubscriptionResetPreferenceIDs(ids...)
	return _u
}

// AddSubscriptionResetPreferences adds the "subscription_reset_preferences" edges to the SubscriptionResetPreference entity.
func (_u *UserUpdate) AddSubscriptionResetPreferences(v ...*SubscriptionResetPreference) *UserUpdate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _u.AddSubscriptionResetPreferenceIDs(ids...)
}
...
// ClearSubscriptionResetCardGrants clears all "subscription_reset_card_grants" edges to the SubscriptionResetCardGrant entity.
func (_u *UserUpdate) ClearSubscriptionResetCardGrants() *UserUpdate {
	_u.mutation.ClearSubscriptionResetCardGrants()
	return _u
}

// RemoveSubscriptionResetCardGrantIDs removes the "subscription_reset_card_grants" edge to SubscriptionResetCardGrant entities by IDs.
func (_u *UserUpdate) RemoveSubscriptionResetCardGrantIDs(ids ...int64) *UserUpdate {
	_u.mutation.RemoveSubscriptionResetCardGrantIDs(ids...)
	return _u
}

// RemoveSubscriptionResetCardGrants removes "subscription_reset_card_grants" edges to SubscriptionResetCardGrant entities.
func (_u *UserUpdate) RemoveSubscriptionResetCardGrants(v ...*SubscriptionResetCardGrant) *UserUpdate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _u.RemoveSubscriptionResetCardGrantIDs(ids...)
}

// ClearIssuedSubscriptionResetCardGrants clears all "issued_subscription_reset_card_grants" edges to the SubscriptionResetCardGrant entity.
func (_u *UserUpdate) ClearIssuedSubscriptionResetCardGrants() *UserUpdate {
	_u.mutation.ClearIssuedSubscriptionResetCardGrants()
	return _u
}

// RemoveIssuedSubscriptionResetCardGrantIDs removes the "issued_subscription_reset_card_grants" edge to SubscriptionResetCardGrant entities by IDs.
func (_u *UserUpdate) RemoveIssuedSubscriptionResetCardGrantIDs(ids ...int64) *UserUpdate {
	_u.mutation.RemoveIssuedSubscriptionResetCardGrantIDs(ids...)
	return _u
}

// RemoveIssuedSubscriptionResetCardGrants removes "issued_subscription_reset_card_grants" edges to SubscriptionResetCardGrant entities.
func (_u *UserUpdate) RemoveIssuedSubscriptionResetCardGrants(v ...*SubscriptionResetCardGrant) *UserUpdate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _u.RemoveIssuedSubscriptionResetCardGrantIDs(ids...)
}
...
func (_u *UserUpdate) ClearSubscriptionResetCardUsages() *UserUpdate {
...
func (_u *UserUpdate) RemoveSubscriptionResetCardUsageIDs(ids ...int64) *UserUpdate {
...
func (_u *UserUpdate) RemoveSubscriptionResetCardUsages(v ...*SubscriptionResetCardUsage) *UserUpdate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearSubscriptionResetPreferences clears all "subscription_reset_preferences" edges to the SubscriptionResetPreference entity.
func (_u *UserUpdate) ClearSubscriptionResetPreferences() *UserUpdate {
	_u.mutation.ClearSubscriptionResetPreferences()
	return _u
}

// RemoveSubscriptionResetPreferenceIDs removes the "subscription_reset_preferences" edge to SubscriptionResetPreference entities by IDs.
func (_u *UserUpdate) RemoveSubscriptionResetPreferenceIDs(ids ...int64) *UserUpdate {
	_u.mutation.RemoveSubscriptionResetPreferenceIDs(ids...)
	return _u
}

// RemoveSubscriptionResetPreferences removes "subscription_reset_preferences" edges to SubscriptionResetPreference entities.
func (_u *UserUpdate) RemoveSubscriptionResetPreferences(v ...*SubscriptionResetPreference) *UserUpdate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
	return _u.RemoveSubscriptionResetPreferenceIDs(ids...)
}
...
func (_u *UserUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if _u.mutation.SubscriptionResetCardGrantsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
	...
	if nodes := _u.mutation.RemovedSubscriptionResetCardGrantsIDs(); len(nodes) > 0 && !_u.mutation.SubscriptionResetCardGrantsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   user.SubscriptionResetCardGrantsTable,
	...
	if nodes := _u.mutation.SubscriptionResetCardGrantsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   user.SubscriptionResetCardGrantsTable,
	...
	if _u.mutation.IssuedSubscriptionResetCardGrantsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
	...
	if nodes := _u.mutation.RemovedIssuedSubscriptionResetCardGrantsIDs(); len(nodes) > 0 && !_u.mutation.IssuedSubscriptionResetCardGrantsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   user.IssuedSubscriptionResetCardGrantsTable,
	...
	if nodes := _u.mutation.IssuedSubscriptionResetCardGrantsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   user.IssuedSubscriptionResetCardGrantsTable,
	...
	if _u.mutation.SubscriptionResetPreferencesCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
	...
	if nodes := _u.mutation.RemovedSubscriptionResetPreferencesIDs(); len(nodes) > 0 && !_u.mutation.SubscriptionResetPreferencesCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   user.SubscriptionResetPreferencesTable,
	...
	if nodes := _u.mutation.SubscriptionResetPreferencesIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   user.SubscriptionResetPreferencesTable,
...
// AddSubscriptionResetCardGrantIDs adds the "subscription_reset_card_grants" edge to the SubscriptionResetCardGrant entity by IDs.
func (_u *UserUpdateOne) AddSubscriptionResetCardGrantIDs(ids ...int64) *UserUpdateOne {
	_u.mutation.AddSubscriptionResetCardGrantIDs(ids...)
	return _u
}

// AddSubscriptionResetCardGrants adds the "subscription_reset_card_grants" edges to the SubscriptionResetCardGrant entity.
func (_u *UserUpdateOne) AddSubscriptionResetCardGrants(v ...*SubscriptionResetCardGrant) *UserUpdateOne {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// AddIssuedSubscriptionResetCardGrantIDs adds the "issued_subscription_reset_card_grants" edge to the SubscriptionResetCardGrant entity by IDs.
func (_u *UserUpdateOne) AddIssuedSubscriptionResetCardGrantIDs(ids ...int64) *UserUpdateOne {
	_u.mutation.AddIssuedSubscriptionResetCardGrantIDs(ids...)
	return _u
}

// AddIssuedSubscriptionResetCardGrants adds the "issued_subscription_reset_card_grants" edges to the SubscriptionResetCardGrant entity.
func (_u *UserUpdateOne) AddIssuedSubscriptionResetCardGrants(v ...*SubscriptionResetCardGrant) *UserUpdateOne {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// AddSubscriptionResetCardUsageIDs adds the "subscription_reset_card_usages" edge to the SubscriptionResetCardUsage entity by IDs.
func (_u *UserUpdateOne) AddSubscriptionResetCardUsageIDs(ids ...int64) *UserUpdateOne {
	_u.mutation.AddSubscriptionResetCardUsageIDs(ids...)
	return _u
}

// AddSubscriptionResetCardUsages adds the "subscription_reset_card_usages" edges to the SubscriptionResetCardUsage entity.
func (_u *UserUpdateOne) AddSubscriptionResetCardUsages(v ...*SubscriptionResetCardUsage) *UserUpdateOne {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// AddSubscriptionResetPreferenceIDs adds the "subscription_reset_preferences" edge to the SubscriptionResetPreference entity by IDs.
func (_u *UserUpdateOne) AddSubscriptionResetPreferenceIDs(ids ...int64) *UserUpdateOne {
	_u.mutation.AddSubscriptionResetPreferenceIDs(ids...)
	return _u
}

// AddSubscriptionResetPreferences adds the "subscription_reset_preferences" edges to the SubscriptionResetPreference entity.
func (_u *UserUpdateOne) AddSubscriptionResetPreferences(v ...*SubscriptionResetPreference) *UserUpdateOne {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearSubscriptionResetCardGrants clears all "subscription_reset_card_grants" edges to the SubscriptionResetCardGrant entity.
func (_u *UserUpdateOne) ClearSubscriptionResetCardGrants() *UserUpdateOne {
	_u.mutation.ClearSubscriptionResetCardGrants()
	return _u
}

// RemoveSubscriptionResetCardGrantIDs removes the "subscription_reset_card_grants" edge to SubscriptionResetCardGrant entities by IDs.
func (_u *UserUpdateOne) RemoveSubscriptionResetCardGrantIDs(ids ...int64) *UserUpdateOne {
	_u.mutation.RemoveSubscriptionResetCardGrantIDs(ids...)
	return _u
}

// RemoveSubscriptionResetCardGrants removes "subscription_reset_card_grants" edges to SubscriptionResetCardGrant entities.
func (_u *UserUpdateOne) RemoveSubscriptionResetCardGrants(v ...*SubscriptionResetCardGrant) *UserUpdateOne {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearIssuedSubscriptionResetCardGrants clears all "issued_subscription_reset_card_grants" edges to the SubscriptionResetCardGrant entity.
func (_u *UserUpdateOne) ClearIssuedSubscriptionResetCardGrants() *UserUpdateOne {
	_u.mutation.ClearIssuedSubscriptionResetCardGrants()
	return _u
}

// RemoveIssuedSubscriptionResetCardGrantIDs removes the "issued_subscription_reset_card_grants" edge to SubscriptionResetCardGrant entities by IDs.
func (_u *UserUpdateOne) RemoveIssuedSubscriptionResetCardGrantIDs(ids ...int64) *UserUpdateOne {
	_u.mutation.RemoveIssuedSubscriptionResetCardGrantIDs(ids...)
	return _u
}

// RemoveIssuedSubscriptionResetCardGrants removes "issued_subscription_reset_card_grants" edges to SubscriptionResetCardGrant entities.
func (_u *UserUpdateOne) RemoveIssuedSubscriptionResetCardGrants(v ...*SubscriptionResetCardGrant) *UserUpdateOne {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearSubscriptionResetCardUsages clears all "subscription_reset_card_usages" edges to the SubscriptionResetCardUsage entity.
func (_u *UserUpdateOne) ClearSubscriptionResetCardUsages() *UserUpdateOne {
	_u.mutation.ClearSubscriptionResetCardUsages()
	return _u
}

// RemoveSubscriptionResetCardUsageIDs removes the "subscription_reset_card_usages" edge to SubscriptionResetCardUsage entities by IDs.
func (_u *UserUpdateOne) RemoveSubscriptionResetCardUsageIDs(ids ...int64) *UserUpdateOne {
	_u.mutation.RemoveSubscriptionResetCardUsageIDs(ids...)
	return _u
}

// RemoveSubscriptionResetCardUsages removes "subscription_reset_card_usages" edges to SubscriptionResetCardUsage entities.
func (_u *UserUpdateOne) RemoveSubscriptionResetCardUsages(v ...*SubscriptionResetCardUsage) *UserUpdateOne {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearSubscriptionResetPreferences clears all "subscription_reset_preferences" edges to the SubscriptionResetPreference entity.
func (_u *UserUpdateOne) ClearSubscriptionResetPreferences() *UserUpdateOne {
	_u.mutation.ClearSubscriptionResetPreferences()
	return _u
}

// RemoveSubscriptionResetPreferenceIDs removes the "subscription_reset_preferences" edge to SubscriptionResetPreference entities by IDs.
func (_u *UserUpdateOne) RemoveSubscriptionResetPreferenceIDs(ids ...int64) *UserUpdateOne {
	_u.mutation.RemoveSubscriptionResetPreferenceIDs(ids...)
	return _u
}

// RemoveSubscriptionResetPreferences removes "subscription_reset_preferences" edges to SubscriptionResetPreference entities.
func (_u *UserUpdateOne) RemoveSubscriptionResetPreferences(v ...*SubscriptionResetPreference) *UserUpdateOne {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
