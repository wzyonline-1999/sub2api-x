...
func (_u *GroupUpdate) AddSubscriptionResetCardGrantIDs(ids ...int64) *GroupUpdate {
...
func (_u *GroupUpdate) AddSubscriptionResetCardGrants(v ...*SubscriptionResetCardGrant) *GroupUpdate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *GroupUpdate) AddSubscriptionResetCardUsageIDs(ids ...int64) *GroupUpdate {
...
func (_u *GroupUpdate) AddSubscriptionResetCardUsages(v ...*SubscriptionResetCardUsage) *GroupUpdate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *GroupUpdate) AddSubscriptionResetPreferenceIDs(ids ...int64) *GroupUpdate {
...
func (_u *GroupUpdate) AddSubscriptionResetPreferences(v ...*SubscriptionResetPreference) *GroupUpdate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *GroupUpdate) ClearSubscriptionResetCardGrants() *GroupUpdate {
...
func (_u *GroupUpdate) RemoveSubscriptionResetCardGrantIDs(ids ...int64) *GroupUpdate {
...
func (_u *GroupUpdate) RemoveSubscriptionResetCardGrants(v ...*SubscriptionResetCardGrant) *GroupUpdate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *GroupUpdate) ClearSubscriptionResetCardUsages() *GroupUpdate {
...
func (_u *GroupUpdate) RemoveSubscriptionResetCardUsageIDs(ids ...int64) *GroupUpdate {
...
func (_u *GroupUpdate) RemoveSubscriptionResetCardUsages(v ...*SubscriptionResetCardUsage) *GroupUpdate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *GroupUpdate) ClearSubscriptionResetPreferences() *GroupUpdate {
...
func (_u *GroupUpdate) RemoveSubscriptionResetPreferenceIDs(ids ...int64) *GroupUpdate {
...
func (_u *GroupUpdate) RemoveSubscriptionResetPreferences(v ...*SubscriptionResetPreference) *GroupUpdate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *GroupUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if _u.mutation.SubscriptionResetCardGrantsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   group.SubscriptionResetCardGrantsTable,
			Columns: []string{group.SubscriptionResetCardGrantsColumn},
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
	...
	if _u.mutation.SubscriptionResetCardUsagesCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   group.SubscriptionResetCardUsagesTable,
			Columns: []string{group.SubscriptionResetCardUsagesColumn},
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
	...
	if _u.mutation.SubscriptionResetPreferencesCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   group.SubscriptionResetPreferencesTable,
			Columns: []string{group.SubscriptionResetPreferencesColumn},
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
...
// AddSubscriptionResetCardGrantIDs adds the "subscription_reset_card_grants" edge to the SubscriptionResetCardGrant entity by IDs.
func (_u *GroupUpdateOne) AddSubscriptionResetCardGrantIDs(ids ...int64) *GroupUpdateOne {
	_u.mutation.AddSubscriptionResetCardGrantIDs(ids...)
	return _u
}

// AddSubscriptionResetCardGrants adds the "subscription_reset_card_grants" edges to the SubscriptionResetCardGrant entity.
func (_u *GroupUpdateOne) AddSubscriptionResetCardGrants(v ...*SubscriptionResetCardGrant) *GroupUpdateOne {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// AddSubscriptionResetCardUsageIDs adds the "subscription_reset_card_usages" edge to the SubscriptionResetCardUsage entity by IDs.
func (_u *GroupUpdateOne) AddSubscriptionResetCardUsageIDs(ids ...int64) *GroupUpdateOne {
	_u.mutation.AddSubscriptionResetCardUsageIDs(ids...)
	return _u
}

// AddSubscriptionResetCardUsages adds the "subscription_reset_card_usages" edges to the SubscriptionResetCardUsage entity.
func (_u *GroupUpdateOne) AddSubscriptionResetCardUsages(v ...*SubscriptionResetCardUsage) *GroupUpdateOne {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// AddSubscriptionResetPreferenceIDs adds the "subscription_reset_preferences" edge to the SubscriptionResetPreference entity by IDs.
func (_u *GroupUpdateOne) AddSubscriptionResetPreferenceIDs(ids ...int64) *GroupUpdateOne {
	_u.mutation.AddSubscriptionResetPreferenceIDs(ids...)
	return _u
}

// AddSubscriptionResetPreferences adds the "subscription_reset_preferences" edges to the SubscriptionResetPreference entity.
func (_u *GroupUpdateOne) AddSubscriptionResetPreferences(v ...*SubscriptionResetPreference) *GroupUpdateOne {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearSubscriptionResetCardGrants clears all "subscription_reset_card_grants" edges to the SubscriptionResetCardGrant entity.
func (_u *GroupUpdateOne) ClearSubscriptionResetCardGrants() *GroupUpdateOne {
	_u.mutation.ClearSubscriptionResetCardGrants()
	return _u
}

// RemoveSubscriptionResetCardGrantIDs removes the "subscription_reset_card_grants" edge to SubscriptionResetCardGrant entities by IDs.
func (_u *GroupUpdateOne) RemoveSubscriptionResetCardGrantIDs(ids ...int64) *GroupUpdateOne {
	_u.mutation.RemoveSubscriptionResetCardGrantIDs(ids...)
	return _u
}

// RemoveSubscriptionResetCardGrants removes "subscription_reset_card_grants" edges to SubscriptionResetCardGrant entities.
func (_u *GroupUpdateOne) RemoveSubscriptionResetCardGrants(v ...*SubscriptionResetCardGrant) *GroupUpdateOne {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearSubscriptionResetCardUsages clears all "subscription_reset_card_usages" edges to the SubscriptionResetCardUsage entity.
func (_u *GroupUpdateOne) ClearSubscriptionResetCardUsages() *GroupUpdateOne {
	_u.mutation.ClearSubscriptionResetCardUsages()
	return _u
}

// RemoveSubscriptionResetCardUsageIDs removes the "subscription_reset_card_usages" edge to SubscriptionResetCardUsage entities by IDs.
func (_u *GroupUpdateOne) RemoveSubscriptionResetCardUsageIDs(ids ...int64) *GroupUpdateOne {
	_u.mutation.RemoveSubscriptionResetCardUsageIDs(ids...)
	return _u
}

// RemoveSubscriptionResetCardUsages removes "subscription_reset_card_usages" edges to SubscriptionResetCardUsage entities.
func (_u *GroupUpdateOne) RemoveSubscriptionResetCardUsages(v ...*SubscriptionResetCardUsage) *GroupUpdateOne {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearSubscriptionResetPreferences clears all "subscription_reset_preferences" edges to the SubscriptionResetPreference entity.
func (_u *GroupUpdateOne) ClearSubscriptionResetPreferences() *GroupUpdateOne {
	_u.mutation.ClearSubscriptionResetPreferences()
	return _u
}

// RemoveSubscriptionResetPreferenceIDs removes the "subscription_reset_preferences" edge to SubscriptionResetPreference entities by IDs.
func (_u *GroupUpdateOne) RemoveSubscriptionResetPreferenceIDs(ids ...int64) *GroupUpdateOne {
	_u.mutation.RemoveSubscriptionResetPreferenceIDs(ids...)
	return _u
}

// RemoveSubscriptionResetPreferences removes "subscription_reset_preferences" edges to SubscriptionResetPreference entities.
func (_u *GroupUpdateOne) RemoveSubscriptionResetPreferences(v ...*SubscriptionResetPreference) *GroupUpdateOne {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
