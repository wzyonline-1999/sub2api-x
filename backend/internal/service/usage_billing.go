...
type UsageBillingCommand struct {
	...
	SubscriptionDailyWindowVersion   int64
	SubscriptionWeeklyWindowVersion  int64
	SubscriptionMonthlyWindowVersion int64
	AccountType                      string
	Model                            string
	ServiceTier                      string
...
func buildUsageBillingFingerprint(c *UsageBillingCommand) string {
	...
	raw := fmt.Sprintf(
		"%d|%d|%d|%s|%s|%s|%s|%d|%d|%d|%d|%d|%d|%s|%d|%d|%d|%d|%0.10f|%0.10f|%0.10f|%0.10f|%0.10f",
		c.UserID,
		c.AccountID,
		c.APIKeyID,
		...
		c.SubscriptionDailyWindowVersion,
		c.SubscriptionWeeklyWindowVersion,
		c.SubscriptionMonthlyWindowVersion,
		c.BalanceCost,
		c.SubscriptionCost,
		c.APIKeyQuotaCost,
