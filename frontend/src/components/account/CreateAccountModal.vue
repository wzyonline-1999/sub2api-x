    ...
    >
        ...
        <div class="border-t border-gray-200 pt-4 dark:border-dark-600">
          ...
          <template v-else>
            ...
            <div v-if="modelRestrictionMode === 'whitelist'">
              <ModelWhitelistSelector v-model="allowedModels" :platform="form.platform" :account-type="form.type" :sync-credentials="syncPreviewCredentials" />
      ...
      <div v-if="form.platform === 'anthropic' && accountCategory === 'bedrock'" class="space-y-4">
        ...
        <div class="border-t border-gray-200 pt-4 dark:border-dark-600">
          ...
          <!-- Whitelist Mode -->
          <div v-if="modelRestrictionMode === 'whitelist'">
            <ModelWhitelistSelector v-model="allowedModels" platform="anthropic" :account-type="form.type" :sync-credentials="syncPreviewCredentials" />
            <p class="text-xs text-gray-500 dark:text-gray-400">
              {{ t('admin.accounts.selectedModels', { count: allowedModels.length }) }}
      ...
      <div
        v-if="(form.platform === 'openai' || form.platform === 'gemini' || form.platform === 'grok') && accountCategory === 'oauth-based'"
        class="border-t border-gray-200 pt-4 dark:border-dark-600"
      >
        <label class="input-label">{{ t('admin.accounts.modelRestriction') }}</label>
