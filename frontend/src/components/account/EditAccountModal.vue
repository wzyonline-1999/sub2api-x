<template>
  ...
  >
    ...
    >
        ...
        <div v-if="account.platform !== 'antigravity'" class="border-t border-gray-200 pt-4 dark:border-dark-600">
          ...
          <template v-else>
            ...
            <div v-if="modelRestrictionMode === 'whitelist'">
              <ModelWhitelistSelector v-model="allowedModels" :platform="account?.platform || 'anthropic'" :account-type="account?.type" :account-id="account?.id" />
      ...
      <div
        v-if="(account.platform === 'openai' || account.platform === 'gemini') && account.type === 'oauth'"
...
const syncFormFromAccount = (newAccount: Account | null) => {
  ...
  if (newAccount.type === 'apikey' && newAccount.credentials) {
    ...
    if ((newAccount.platform === 'openai' || newAccount.platform === 'gemini') && newAccount.credentials) {
