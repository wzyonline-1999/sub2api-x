export default {
  ...
  capacity: {
    ...
    sortDefault: '默认排序',
    visibleGroups: '可见分组',
    groupCount: '共 {count} 个',
    groupConcurrency: '分组并发',
    accountConcurrency: '账号并发',
    groupLoad: '分组负载 {percentage}%',
    groupLoadLabel: '分组负载',
    waiting: '排队 {count}',
    remaining: '剩余并发 {count}',
    accountLoad: '账号并发负载',
    accountLoadLabel: '账号负载',
    configuredAccounts: '{count} 个已配置',
    quotaLoad: '分组额度负载',
    lowerIsBetter: '越低越好',
    fiveHour: '5 小时',
    sevenDay: '7 天',
    quotaCoverage: '覆盖 {covered} / {total} 个账号',
    loadCapability: '可调度能力',
    higherIsBetter: '越高越好',
    schedulable: '可调度 {available} / {total}',
    status: {
      healthy: '充足',
      warning: '偏紧',
      critical: '高压'
    ...
    summary: {
      ...
      availableConcurrencyNote: '剩余 {percentage}% · 当前使用 {current}',
      loadCapability: '整体可调度能力',
      loadCapabilityNote: '综合可调度资源 · 越高越好',
      waiting: '等待队列',
      requests: '个请求',
      waitingNote: '来自 {groups} 个分组',
      noWaiting: '当前无排队请求',
      stressed: '紧张分组',
    ...
    noMatchesTitle: '没有匹配的分组',
    noMatchesDescription: '请调整平台筛选或搜索关键词。'
  },
