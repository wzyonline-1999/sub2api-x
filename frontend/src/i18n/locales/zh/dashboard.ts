export default {
  ...
  rankings: {
    ...
    totalTokens: '总 Token',
    actualCost: '实际花费',
    currentSortBasis: '当前排序口径',
    syncedCost: '同步展示花费',
    rankedAccounts: '上榜账号',
    calledThisPeriod: '当前周期有调用',
    myRank: '我的排名',
    loading: '正在加载排行榜...',
    topThree: '{period}前三名',
    rankPosition: '第 {rank} 名',
    noRankingData: '当前周期暂无排行数据',
    status: {
      title: '榜单状态',
      period: '统计周期',
      updatedAt: '更新时间',
    ...
    fourthToTenth: '第 4-10 名',
    callSingular: '{count} 次调用',
    callPlural: '{count} 次调用',
    myAccount: '我的账号',
    relativeToLeader: '相对榜首',
    relativeProgress: '相对榜首进度',
    noMoreRanks: '暂无更多排名',
    periods: {
      day: '日榜',
      week: '周榜',
    ...
    unranked: '未上榜',
    summit: '已登顶',
    gapToRanking: '距离上榜还差 {gap}',
    keepLead: '继续保持当前榜首',
    keepLeadWithMetric: '{metric} · 继续保持当前榜首',
    gapToPreviousWithMetric: '{metric} · 距离超过上一名还差 {gap}',
    currentMetric: '当前 {metric}',
    noCallsThisPeriod: '当前周期暂无调用',
    summitWithMetric: '已登顶 · {metric}',
    gapToPrevious: '距离超过上一名还差 {gap}',
    rankedWithMetric: '第 {rank} 名 · {metric}',
    chaseRankTarget: '以第 {rank} 名作为追赶目标',
    oneStepBehindPrevious: '距离超过上一名还差一步',
    rankThresholdTarget: '以第 {rank} 名作为上榜门槛',
    topTenThreshold: '以当前 Top10 末位作为上榜门槛',
    enteredTopTen: '已进入当前 Top10',
    tenthPlaceThreshold: '以第 10 名作为上榜门槛',
    openRankingHint: '当前榜单未满，产生用量即可上榜',
    actualCostValue: '{cost} 实际花费',
    tokenSingular: 'token',
    tokenPlural: 'tokens',
    trendNew: '新增',
    trendFlat: '持平',
