export default {
  ...
  capacity: {
    ...
    refreshFailed: 'Update failed; retry manually',
    platform: 'Platform',
    allPlatforms: 'All',
    searchPlaceholder: 'Search groups',
    sortLabel: 'Sort order',
    sortPressure: 'Pressure first',
    sortDefault: 'Default order',
    visibleGroups: 'Visible groups',
    groupCount: '{count} total',
    groupConcurrency: 'Group concurrency',
    accountConcurrency: 'Account concurrency',
    groupLoad: 'Group load {percentage}%',
    groupLoadLabel: 'Group load',
    waiting: '{count} waiting',
    remaining: '{count} remaining',
    accountLoad: 'Account concurrency load',
    accountLoadLabel: 'Account load',
    configuredAccounts: '{count} configured',
    quotaLoad: 'Group quota load',
    lowerIsBetter: 'lower is better',
    fiveHour: '5 hours',
    sevenDay: '7 days',
    quotaCoverage: '{covered} / {total} accounts covered',
    loadCapability: 'Schedulable capacity',
    higherIsBetter: 'higher is better',
    schedulable: '{available} / {total} schedulable',
    status: {
      healthy: 'Healthy',
      warning: 'Tight',
    ...
    summary: {
      ...
      availableConcurrencyNote: '{percentage}% remaining · {current} in use',
      loadCapability: 'Overall schedulable capacity',
      loadCapabilityNote: 'Combined schedulable resources · higher is better',
      waiting: 'Waiting queue',
      requests: 'requests',
      waitingNote: 'Across {groups} groups',
      noWaiting: 'No requests are waiting',
    ...
    noMatchesTitle: 'No matching groups',
    noMatchesDescription: 'Change the platform filter or search term.'
  },
