export default {
  ...
  rankings: {
    ...
    currentSortBasis: 'Current ranking metric',
    syncedCost: 'Spend shown for reference',
    rankedAccounts: 'Ranked accounts',
    calledThisPeriod: 'Active in this period',
    myRank: 'My rank',
    loading: 'Loading rankings...',
    topThree: 'Top three · {period}',
    ...
    status: {
      ...
      updatedAt: 'Updated',
      scope: 'Scope',
      scopeValue: 'Verified accounts site-wide'
    },
    fourthToTenth: 'Ranks 4-10',
    callSingular: '{count} call',
    callPlural: '{count} calls',
    myAccount: 'My account',
    relativeToLeader: 'Relative to leader',
    relativeProgress: 'Progress relative to leader',
    noMoreRanks: 'No more ranked accounts',
    periods: {
      day: 'Daily',
      week: 'Weekly',
      month: 'Monthly'
    ...
    unranked: 'Unranked',
    summit: 'Ranked first',
    gapToRanking: '{gap} to enter the ranking',
    keepLead: 'Keep the lead',
    keepLeadWithMetric: '{metric} · Keep the lead',
    gapToPreviousWithMetric: '{metric} · {gap} to pass the previous rank',
    currentMetric: 'Current: {metric}',
    noCallsThisPeriod: 'No usage in this period',
    summitWithMetric: 'Ranked first · {metric}',
    gapToPrevious: '{gap} to pass the previous rank',
    rankedWithMetric: 'Rank {rank} · {metric}',
    chaseRankTarget: 'Chasing rank {rank}',
    oneStepBehindPrevious: 'One step away from the previous rank',
    rankThresholdTarget: 'Rank {rank} is the entry threshold',
    topTenThreshold: 'The current Top 10 cutoff is the entry threshold',
    enteredTopTen: 'Currently in the Top 10',
    tenthPlaceThreshold: 'Rank 10 is the entry threshold',
    openRankingHint: 'The ranking is not full; generate usage to enter',
    actualCostValue: '{cost} actual spend',
    tokenSingular: 'token',
    tokenPlural: 'tokens',
    trendNew: 'New',
    trendFlat: 'No change',
