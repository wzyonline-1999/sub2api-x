export default {
    ops: {
      ...
      active: 'active',
      idle: 'idle',
      dbWaitEventsDelta: 'wait events Δ',
      conns: 'conns',
      queue: 'queue',
      ...
      tooltips: {
        ...
        db: 'Database connection pool status. Active and idle are current connection counts; wait events Δ is the number of new connection-wait events in this sampling window, not the number of connections currently waiting.',
